...
`x` 키로 선택된 문헌을 내보낼 수 있습니다.

- **BibTeX (.bib)**: BibTeX 엔트리 형식으로 내보내기. 인용키, 저자, 제목, 저널, 연도, DOI, arXiv, 키워드, 파일 경로 포함
- **CSL JSON**: Citation Style Language 호환 JSON 포맷. Typst, LaTeX, pandoc, Zotero 등 외부 도구에서 직접 소비 가능
